...
void Camera::Update()
{
	...
	m_upwards.y = sin((m_orientation.x) * 3.1415f / 180.0f);
	m_upwards.z = cos((m_orientation.x) * 3.1415f / 180.0f);
	m_upwards.Normalize();
...
DirectX::SimpleMath::Vector3 Camera::getUpwards()
{
	return m_upwards;
}
